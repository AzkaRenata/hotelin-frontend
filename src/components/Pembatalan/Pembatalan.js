...
export class Pembatalan extends PureComponent {
    ...
    getData() {
        axios
            .get(API_BASE_URL+'/booking/canceled', { headers: { "Authorization": `Bearer ${localStorage.getItem(ACCESS_TOKEN_NAME)}`}})
            .then(res => {
                var tdata = res.data;
...
export default withRouter(Pembatalan);